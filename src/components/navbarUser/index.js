...
import Vector4 from '../../assets/bell.svg'
import Vector5 from '../../assets/mail.svg'
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav nav-list ml-auto">
                            <li className="nav-item active">
                                <Link to='/my-bag' className="nav-link" href="my-bag.html"><img src={Vector2} alt=""/></Link>
                            </li>
                            <li className="nav-item">
                                <Link to='' className="nav-link" href="#"><img src={Vector4} alt=""/></Link>
                            </li>
                            <li className="nav-item">
                                <Link to='' className="nav-link" href="#"><img src={Vector5} alt=""/></Link>
                            </li>
                            <li className="nav-item ">
                                <Link to={`${user.role === 'customer' ? `${`/profile/${user.id}`}` : `${`/profile-seller/${user.id}`}`}`} className="nav-link" href="profile.html"><img className="profile-navbar" src={user.profilePicture} alt=""/></Link>
                            </li>
                        </ul>
                    </div>
                </div>
